class PagesReport extends Report {
    ...
    addStats() {
        ...
        for (var name in data_pages_stat) {
    ...
    insertDataToTable() {
        ...
        do {
            var page_id = this.pages.get("id"),
                ...
                requests_cached_percent = this.pages.get("requests_cached_percent"),
                requests_cached_text = requests_cached_percent === null ? "" : requests_cached_percent + "%",
    ...
    _backlinkHTML(backlink_id) {
        ...
        if (relative_url === "/") {
            ...
            backlink_title = relative_url;
        }
        return '<a href="' + full_url + '" title="' + backlink_title + '"><i class="external alternate icon"></i></a>';
    }
